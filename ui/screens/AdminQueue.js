...
const styles = StyleSheet.create({
    ...
    card: {
        ...
        borderWidth: 2,
        marginBottom: 20,
        ...getShadow('#000', { width: 0, height: 4 }, 0.15, 8, 4)
    },
    cardInfo: {
        flex: 1,
        marginBottom: 20
    ...
    slaIndicator: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        ...getShadow('#000', { width: 0, height: 2 }, 0.2, 4, 3)
    },
    blockerSection: {
        marginTop: 12,
        padding: 14,
    ...
    btn: {
        ...
        alignItems: 'center',
        marginTop: 8,
        ...getShadow('#000', { width: 0, height: 2 }, 0.1, 3, 2)
    },
    btnText: {
        color: '#FFF',
        fontWeight: '700',
    ...
    modalContent: {
        ...
        borderRadius: 16,
        padding: 24,
        ...getShadow('#000', { width: 0, height: 8 }, 0.4, 16, 12)
    },
    modalHeader: {
        flexDirection: 'row',
        justifyContent: 'space-between',
